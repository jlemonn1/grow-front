...
export const TOUR_STEPS_PHASE1: TourStep[] = [
  ...
  },
  {
    ...
    description: 'Busca productos por nombre. Verás stock disponible y precio de venta.',
    position: 'bottom',
    waitForElement: true,
    delay: 300,
    autoAction: {
  ...
  },
  {
    ...
    title: 'Especificar Cantidad',
    description: 'Indica la cantidad a dispensar. Puedes usar botones rápidos o escribir manualmente.',
    position: 'bottom',
    waitForElement: true,
    delay: 300,
    autoAction: {
  ...
  },
  {
    ...
    description: 'Escribiendo cantidad...',
    position: 'bottom',
    waitForElement: true,
    delay: 200,
    autoAdvance: true,
  ...
  },
  {
    ...
    description: 'Establece el precio de venta. Este será el precio base del producto.',
    position: 'bottom',
    waitForElement: true,
    delay: 300,
    autoAction: {
  ...
  },
  {
    ...
    title: 'Stock Inicial',
    description: 'Define el stock inicial. El sistema rastreará los movimientos automáticamente.',
    position: 'bottom',
    waitForElement: true,
    delay: 300,
    autoAction: {
  ...
  },
  {
    ...
    title: 'Detalles del Producto',
    description: 'Aquí puedes ver toda la información del producto: nombre, categoría, precio de venta, stock actual, descripción e imagen. También puedes realizar acciones como recargar stock, editar o eliminar el producto.',
    position: 'top',
    waitForElement: true,
    delay: 500,
    autoAdvance: true,
  ...
  },
  {
    ...
    title: 'Especificar Cantidad',
    description: 'Indica la cantidad que quieres agregar al stock.',
    position: 'bottom',
    waitForElement: true,
    delay: 300,
    autoAction: {
  ...
  },
  {
    ...
    route: '/products/:id', // Se actualizará dinámicamente (modal abierto)
    selector: '[data-tour="recharge-stock-grams-input"]',
    title: 'Escribiendo Cantidad',
    description: 'Escribiendo 50 unidades...',
    position: 'bottom',
    waitForElement: true,
    delay: 200,
    autoAdvance: true,
  ...
  },
  {
    ...
    description: 'En la pestaña "Resumen" puedes ver un análisis de las compras: total gastado y cantidad por producto.',
    position: 'top',
    waitForElement: true,
    delay: 500,
    autoAdvance: true,
